	...
	var _public = (function() {
		...
		var _defaults = {
            ...
            */
			...
			onPageChange: function(e, page) {
				// option for behavior on page change
			}
		};
        ...
        */
		...
		_private.buildNavigation = function() {
			...
			if (lastPage >= 1) {
				if (lastPage < 6) {
					for (var i = 1, items = []; i <= lastPage; i += 1) {
						items.push(i);
					}
        ...
        */
		$("body").on("click", "#paginator-next-page", function(e) {
			e.preventDefault();
			_private.$el.paginator("nextPage", e);
		});
		$("body").on("click", "#paginator-prev-page", function(e) {
			e.preventDefault();
			_private.$el.paginator("prevPage", e);
		});
		...
		return {
            ...
            */
			...
			setPage: function(page) {
				...
				_private.page = page;
				_options.onPageChange(e, _private.page);
				_private.run();
			},
